...
def find_middle_risk_government_bonds():
    risk_list=[]
    k=1
    for bond in bonds:
        time.sleep(1.5) #Обход ограничения числа запросов в мин(
...
def find_risk_gold(): #Можно заменить средний по товарам/валютам, но нужно придумать принцип выбора: что включать, а что нет
...
#РЕЗУЛЬТАТ
#[0.23972445089345876, 0.204465939583233, 0.19128898294386373]
